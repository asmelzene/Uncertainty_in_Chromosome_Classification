...
l_seed = [81, 87, 51, 59, 23, 1, 3, 5, 7, 11, 15]
...
for rand_seed in l_seed:
    ...
    p1 = subprocess.Popen(['python', '../config/update_config.py', '--config', '../config/config_squeezenet1_0.ini', '--config_new', '../config/config_squeezenet1_0.ini', '--section', 'data', '--key', 'seed', '--value', str(rand_seed)])
    p1.wait()
