...
import pytorch_pretrained_models_ALEXNET as ppm
...
class c_train_model:
    ...
    def train_model(self):
        ...
        elif self.optim_selected == 'ReduceLROnPlateau':
            self.optimizer_ft = optim.SGD(params_to_update, lr=self.lr, momentum=self.momentum)
