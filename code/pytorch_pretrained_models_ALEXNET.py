...
class pt_model:
    ...
    def train(self, model, dataloaders, criterion, optimizer, num_epochs=25, is_inception=False):
        ...
        #scheduler.step()
        elif optim_selected == 'ReduceLROnPlateau':
            scheduler = torch.optim.lr_scheduler.ReduceLROnPlateau(optimizer, mode='min', factor=0.1, patience=2, threshold=0.00001, threshold_mode='rel', cooldown=0, min_lr=0, eps=1e-08, verbose=False)
